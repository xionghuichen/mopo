...
def main():
    ...
    tester.add_record_param(['use_adapt', "model_suffix", "penalty_coeff", "length",
                             'info', 'run_params.seed'])
    tester.configure(task_name=variant["config"], private_config_path=os.path.join(get_package_path(), 'rla_config_mopo.yaml'),
