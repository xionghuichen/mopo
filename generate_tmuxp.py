...
params = {
    ...
    'use_adapt': [True],
    'info': [
        'mixed_hopper_penalty_0.5',
        'mixed_hopper_penalty_0.25',
        'random_hopper_penalty_0.5',
        'random_hopper_penalty_0.25',
        'mixed_walker2d_penalty_0.5',
        'mixed_walker2d_penalty_0.25',
        'random_walker2d_penalty_0.5',
        'random_walker2d_penalty_0.25',
             ],
    'length': [None],
    'penalty_coeff': [0.5, 0.25, 0.5, 0.25, 0.5, 0.25, 0.5, 0.25, ],
    'elite_num': [None],
    'model_suffix': [None]
}
#
